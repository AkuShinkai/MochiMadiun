                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500">
                                                    Are you sure you want to log out? You'll be signed out of your account and will need to sign in again to access your account.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button
                                        type="button"
                                        className="inline-flex w-full justify-center rounded-lg bg-red-600 px-6 py-2 my-1 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto"
                                        onClick={onLogout}
                                    >
                                        Log Out
                                    </button>
